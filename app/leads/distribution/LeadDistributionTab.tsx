...
export default function LeadDistribution() {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-3">Lead Distribution</h1>
        <p className="text-gray-600 text-lg">Manage and distribute leads to your partners</p>
      </div>
