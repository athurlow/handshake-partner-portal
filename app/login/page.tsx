    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #E86A47 0%, #F4B544 100%)' }}>
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <div className="w-40 h-40 mx-auto mb-4 rounded-full overflow-hidden shadow-xl flex items-center justify-center text-8xl" style={{ backgroundColor: '#FFFFFF' }}>
            🤝
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <button onClick={() => window.location.href = '/signup'} className="font-bold hover:underline" style={{ color: '#E86A47' }}>
                Sign Up
              </button>
            </p>
          </div>
